...
export default function Index({ designations = { data: [], links: [] } }) {
    ...
    useEffect(() => {
        ...
        const delayDebounceFn = setTimeout(() => {
            ...
            // Make sure your web.php has this route defined
    ...
    const handlePrint = () => {
        ...
        printWindow.document.write(`
            <html>
                ...
                <body>
                    <h2>Designations Directory Report</h2>
        ...
        <AdminLayout>
            ...
            <div className="slider-page-wrapper" style={{ padding: "24px", background: "#f8fafc" }}>
                ...
                <div className="page-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
                    <div>
                        <h1 className="page-title" style={{ fontSize: "1.75rem", fontWeight: "700", color: "#1e293b", margin: 0 }}>Designation Workspace</h1>
                        <p style={{ fontSize: "0.875rem", color: "#64748b", marginTop: "4px" }}>Manage and track all company designations.</p>
                    </div>
                </div>
                ...
                <div className="card-container" style={{ background: "#ffffff", borderRadius: "12px", boxShadow: "0 4px 6px -1px rgb(0 0 0 / 0.05)", border: "1px solid #e2e8f0" }}>
                    ...
                    <div className="card-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "20px 24px", borderBottom: "1px solid #f1f5f9" }}>
                        <div className="card-title" style={{ fontSize: "1.125rem", fontWeight: "600", color: "#334155" }}>
                            <i className="fa-solid fa-id-badge" style={{ marginRight: "8px", color: "#3b82f6" }}></i> Designation Directory
                        </div>
                    ...
                    <div className="table-toolbar" style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: "16px", padding: "16px 24px", background: "#f8fafc" }}>
                        ...
                        <div className="search-box" style={{ position: "relative" }}>
                            ...
                            <input type="text" placeholder="Search designations..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} style={{ padding: "8px 12px 8px 36px", width: "260px", borderRadius: "6px", border: "1px solid #cbd5e1", outline: "none", fontSize: "0.875rem" }} />
                        </div>
                    </div>
                        ...
                        <table id="printable-table" className="data-table" style={{ width: "100%", borderCollapse: "collapse", textAlign: "left" }}>
                            <thead>
                                <tr style={{ background: "#f1f5f9", borderBottom: "2px solid #e2e8f0" }}>
                                    ...
                                    <th style={{ padding: "14px 24px", fontSize: "0.75rem", fontWeight: "700", color: "#475569", textTransform: "uppercase" }}>Designation Name</th>
                            ...
                            <tbody style={{ color: "#334155", fontSize: "0.915rem" }}>
                                {designations.data && designations.data.length > 0 ? (
                                    designations.data.map((designation, index) => (
                                        <tr key={designation.id} style={{ borderBottom: "1px solid #f1f5f9" }}>
                                            <td style={{ padding: "16px 24px", color: "#64748b", fontWeight: "500" }}>
                                                {designations.from ? designations.from + index : index + 1}
                                            </td>
                                            <td style={{ padding: "16px 24px" }}>
                                                <div style={{ fontWeight: "600", color: "#0f172a" }}>{designation.name}</div>
                                            </td>
                                            <td style={{ padding: "16px 24px" }}>
                                                <div style={{ fontSize: "0.875rem", color: "#475569" }}>{designation.description ? designation.description.substring(0, 50) + '...' : "-"}</div>
                                            </td>
                                            <td style={{ padding: "16px 24px", textAlign: "right" }}>
                                                <div style={{ display: "flex", justifyContent: "flex-end", gap: "6px" }}>
                                                    {hasPermission('view_designation') && (
                                                    <button onClick={() => openViewModal(designation)} style={{ background: "#f0fdf4", border: "none", padding: "6px 10px", borderRadius: "6px", cursor: "pointer", color: "#16a34a" }} title="View Details">
                                                        <i className="fa-regular fa-eye"></i>
                                                    </button>
                                                    )}
                                                    {hasPermission('edit_designation') && (
                                                    <button onClick={() => openEditModal(designation)} style={{ background: "#f1f5f9", border: "none", padding: "6px 10px", borderRadius: "6px", cursor: "pointer", color: "#0f172a" }} title="Edit Designation">
                                                        <i className="fa-regular fa-pen-to-square"></i>
                                                    </button>
                                                    )}
                                                    {hasPermission('delete_designation') && (
                                                    <button onClick={() => handleDelete(designation.id)} style={{ background: "#fee2e2", border: "none", padding: "6px 10px", borderRadius: "6px", cursor: "pointer", color: "#ef4444" }} title="Delete Designation">
                                    ...
                                    <tr>
                                        <td colSpan="4" style={{ textAlign: "center", padding: "32px", color: "#94a3b8" }}>No designations found.</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
                    ...
                    {designations.links && designations.links.length > 3 && (
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "20px 24px", borderTop: "1px solid #e2e8f0", background: "#f8fafc" }}>
                            <div style={{ color: "#64748b", fontSize: "0.875rem" }}>
                                Showing {designations.from || 0} to {designations.to || 0} of {designations.total || 0} entries
                            </div>
                    ...
                    <div style={{ background: "#fff", width: "100%", maxWidth: "500px", borderRadius: "12px", boxShadow: "0 20px 25px -5px rgb(0 0 0 / 0.1)", overflow: "hidden" }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid #e2e8f0", padding: "18px 24px", background: "#f8fafc" }}>
                            <h3 style={{ margin: 0, fontSize: "1.15rem", fontWeight: "600", color: "#1e293b" }}>
                                <i className="fa-solid fa-id-badge" style={{ marginRight: "8px", color: "#2563eb" }}></i> Designation Details
                            </h3>
                        ...
                        <div style={{ padding: "24px" }}>
                            <div style={{ marginBottom: "20px" }}>
                                <span style={{ fontSize: "0.75rem", textTransform: "uppercase", fontWeight: "700", color: "#94a3b8", display: "block", marginBottom: "4px" }}>Designation Name</span>
                                <div style={{ fontSize: "1.1rem", fontWeight: "700", color: "#0f172a" }}>{selectedDesignation.name}</div>
                            </div>
                    ...
                    <div style={{ background: "#fff", width: "100%", maxWidth: "500px", borderRadius: "12px", boxShadow: "0 20px 25px -5px rgb(0 0 0 / 0.1)", overflow: "hidden" }}>
                        ...
                        <form onSubmit={handleSubmit} style={{ padding: "24px" }}>
                            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "16px" }}>
                                <div>
                                    <label style={{ display: "block", fontSize: "0.85rem", fontWeight: "600", color: "#475569", marginBottom: "6px" }}>Designation Name *</label>
                                    <input type="text" value={data.name} onChange={(e) => setData("name", e.target.value)} placeholder="e.g. Software Engineer" style={{ width: "100%", padding: "8px 12px", borderRadius: "6px", border: "1px solid #cbd5e1", outline: "none" }} required />
                                ...
                                <div>
                                    ...
                                    <textarea value={data.description} onChange={(e) => setData("description", e.target.value)} placeholder="Brief description about the role..." style={{ width: "100%", padding: "8px 12px", borderRadius: "6px", border: "1px solid #cbd5e1", resize: "vertical" }} rows="4"></textarea>
