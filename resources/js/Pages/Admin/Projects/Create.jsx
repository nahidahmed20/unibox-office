                                                ...
                                                <div className="lg:col-span-4">
                                                    ...
                                                    <div className="relative">
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="0.00"
                                                            className="w-full rounded-xl border border-gray-300 bg-white pl-15 pr-4 py-3.5 text-[15px] font-black text-emerald-700 outline-none transition-all focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 shadow-sm"
                                                        />
                                                    </div>
                                                </div>
