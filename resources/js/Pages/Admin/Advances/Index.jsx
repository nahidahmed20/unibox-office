            ...
            <div className="flex flex-col gap-8 w-full max-w-[1600px] mx-auto pb-12">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mt-2">
                    <div>
                        ...
                        <h1 className="text-[28px] font-extrabold text-gray-900 tracking-tight">Advance Payments</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                    <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-6 shadow-sm hover:shadow-md transition-all group">
                        ...
                        <div className="relative flex items-center gap-5">
                            ...
                            <div>
                                <p className="mb-1 text-[11.5px] font-bold uppercase tracking-wider text-gray-500">Total Given</p>
                                <h3 className="text-[24px] font-black text-gray-900 m-0 tabular-nums tracking-tight">৳ {Number(grandTotals.given).toLocaleString('en-IN')}</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative overflow-hidden rounded-2xl border border-emerald-200 bg-gradient-to-br from-white to-emerald-50/30 p-6 shadow-sm hover:shadow-md transition-all group">
                        ...
                        <div className="relative flex items-center gap-5">
                            ...
                            <div>
                                <p className="mb-1 text-[11.5px] font-bold uppercase tracking-wider text-emerald-600/90">Total Expensed</p>
                                <h3 className="text-[24px] font-black text-emerald-700 m-0 tabular-nums tracking-tight">৳ {Number(grandTotals.expensed).toLocaleString('en-IN')}</h3>
                            </div>
                        </div>
                    </div>

                    <div className="relative overflow-hidden rounded-2xl border border-purple-200 bg-gradient-to-br from-white to-purple-50/30 p-6 shadow-sm hover:shadow-md transition-all group">
                        ...
                        <div className="relative flex items-center gap-5">
                            ...
                            <div>
                                <p className="mb-1 text-[11.5px] font-bold uppercase tracking-wider text-purple-600/90">Total Returned</p>
                                <h3 className="text-[24px] font-black text-purple-700 m-0 tabular-nums tracking-tight">৳ {Number(grandTotals.returned).toLocaleString('en-IN')}</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative overflow-hidden rounded-2xl border border-rose-200 bg-gradient-to-br from-white to-rose-50/30 p-6 shadow-sm hover:shadow-md transition-all group">
                        ...
                        <div className="relative flex items-center gap-5">
                            ...
                            <div>
                                <p className="mb-1 text-[11.5px] font-bold uppercase tracking-wider text-rose-600/90">Total Due Amount</p>
                                <h3 className="text-[24px] font-black text-rose-700 m-0 tabular-nums tracking-tight">৳ {Number(totalUnsettled).toLocaleString('en-IN')}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        return (
                                            <React.Fragment key={group.user_id}>
                                                ...
                                                {isExpanded && hasMultiple && (
                                                    <tr>
                                                        <td colSpan="10" className="px-8 py-6 bg-slate-50/80 border-b border-gray-200 shadow-inner">
            ...
            {showViewModal && selectedAdvance && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#0A0E1A]/60 backdrop-blur-sm p-4 sm:p-6 overflow-y-auto">
                    <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl flex flex-col relative my-auto animate-[fadeIn_0.2s_ease-out] overflow-hidden">
                        ...
                        {/* Modal Header */}
                        <div className="flex items-center justify-between px-8 py-6 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white pl-36 shrink-0">
                            <div>
                                <h3 className="text-[20px] font-black text-gray-900 tracking-tight">Advance Payment Details</h3>
                        ...
                        {/* Modal Body */}
                        <div className="p-8 flex flex-col md:flex-row gap-8 bg-gray-50/50">
                            <div className="flex-1 space-y-6">
                                <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm flex items-center gap-4">
                                    <div className="h-14 w-14 rounded-2xl bg-indigo-50 flex items-center justify-center text-indigo-600 text-2xl font-black border border-indigo-100 uppercase shadow-inner">
                                        {selectedAdvance.user?.name ? selectedAdvance.user.name.charAt(0) : 'U'}
                                    </div>
                                    <div>
                                        <span className="block text-[11px] font-bold uppercase tracking-wider text-gray-400 mb-1">Employee / Issued To</span>
                                        <h2 className="text-[20px] font-extrabold text-gray-900 m-0">{selectedAdvance.user?.name || "N/A"}</h2>
                                    </div>
                                </div>

                                <div className="grid grid-cols-2 gap-5">
                                    <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
                                        <span className="block text-[11px] font-bold uppercase tracking-wider text-gray-400 mb-1.5">Payment Account</span>
                                    ...
                                    <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
                                        <span className="block text-[11px] font-bold uppercase tracking-wider text-gray-400 mb-1.5">Given Date</span>
                                        <div className="font-bold text-gray-800 flex items-center gap-2">
                                    ...
                                    <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm col-span-2">
                                        <span className="block text-[11px] font-bold uppercase tracking-wider text-gray-400 mb-1.5">Purpose</span>
                                        <div className="font-bold text-gray-800 flex items-center gap-2">
                                ...
                                <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
                                    <span className="block text-[12px] font-bold uppercase tracking-wider text-gray-800 mb-2"><i className="fa-solid fa-align-left text-gray-400 mr-2"></i> Notes & Details</span>
                            ...
                            <div className="w-full md:w-[320px] shrink-0 bg-gray-900 rounded-3xl p-6 text-white shadow-xl relative overflow-hidden flex flex-col justify-between">
                                <div className="absolute top-0 right-0 -mr-8 -mt-8 w-32 h-32 rounded-full bg-white/5 blur-2xl pointer-events-none"></div>
                                <div>
                                    <h4 className="text-[12px] font-bold text-gray-400 uppercase tracking-widest mb-6 border-b border-gray-800 pb-3">Financial Status</h4>
                                    <div className="space-y-4">
                                        <div className="flex justify-between items-end"><span className="text-[13.5px] text-gray-300">Total Given</span><span className="text-[16px] font-bold text-white tabular-nums">৳ {Number(selectedAdvance.amount).toLocaleString('en-IN')}</span></div>
                                        <div className="flex justify-between items-end"><span className="text-[13.5px] text-emerald-400">Expensed / Adjusted</span><span className="text-[16px] font-bold text-emerald-400 tabular-nums">৳ {Number(selectedAdvance.settled_amount).toLocaleString('en-IN')}</span></div>
                                        <div className="flex justify-between items-end"><span className="text-[13.5px] text-blue-400">Cash Returned</span><span className="text-[16px] font-bold text-blue-400 tabular-nums">৳ {Number(selectedAdvance.returned_amount).toLocaleString('en-IN')}</span></div>
                                    </div>
                                </div>
                                <div className="pt-5 border-t border-gray-800 mt-6">
                                    <div className="flex justify-between items-end">
                                        <span className="text-[13px] text-rose-300 font-bold uppercase tracking-wider">Currently Due</span>
                                        <span className="text-[24px] font-black text-rose-400 tabular-nums">৳ {Number(selectedAdvance.amount - selectedAdvance.settled_amount - selectedAdvance.returned_amount).toLocaleString('en-IN')}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl flex flex-col my-auto max-h-[95vh] overflow-hidden animate-[fadeIn_0.2s_ease-out]">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
                            <div className="flex flex-col lg:flex-row flex-1 overflow-hidden">
                                ...
                                <div className="w-full lg:w-[340px] shrink-0 bg-[#111827] p-8 text-white flex flex-col justify-between">
                                    <div>
                                        <h3 className="text-[12px] font-bold text-gray-400 uppercase tracking-widest mb-6 border-b border-gray-800 pb-3">Transaction Details</h3>
                                        <div className="space-y-6">
                                            ...
                                            <div>
                                                ...
                                                <select value={data.status} onChange={e => setData('status', e.target.value)} className="w-full appearance-none rounded-xl border border-gray-700 bg-gray-800 px-4 py-3.5 text-[14px] font-semibold text-white outline-none focus:border-indigo-500 cursor-pointer">
                            ...
                            <div className="px-8 py-5 border-t border-gray-200 bg-gray-50 flex items-center justify-end gap-3 shrink-0 rounded-b-3xl">
                                ...
                                <button type="submit" disabled={processing} className="flex items-center gap-2 rounded-xl bg-indigo-600 px-8 py-3 text-[14.5px] font-bold text-white transition-all shadow-md hover:bg-indigo-700 disabled:opacity-70">
                    ...
                    <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden animate-[fadeIn_0.2s_ease-out]">
                        <div className="flex items-center justify-between px-6 py-5 border-b border-emerald-100 bg-emerald-50 shrink-0">
                            <div>
                                ...
                                <p className="text-[12.5px] text-emerald-600 font-medium mt-1">Returning cash from <b>{selectedAdvance.user?.name || 'N/A'}</b></p>
                            </div>
                        ...
                        <form onSubmit={handleReturnSubmit} className="flex flex-col overflow-hidden">
                            ...
                            <div className="px-6 py-5 border-t border-gray-100 bg-gray-50 flex justify-end gap-3 shrink-0 rounded-b-3xl">
                                <button type="button" onClick={() => setShowReturnModal(false)} className="rounded-xl border border-gray-300 bg-white px-5 py-2.5 text-[14px] font-bold text-gray-700 transition-colors hover:bg-gray-100 shadow-sm">Cancel</button>
                                <button type="submit" disabled={returnProcessing} className="rounded-xl bg-emerald-600 px-6 py-2.5 text-[14px] font-bold text-white transition-all hover:bg-emerald-700 shadow-md disabled:opacity-70 flex items-center gap-2">
