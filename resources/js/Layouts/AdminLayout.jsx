...
export default function AdminLayout({ children }) {
    ...
    const [openMenus, setOpenMenus] = useState({
        ...
        finance: route().current('admin.invoices.*') || route().current('admin.expenses.*') || route().current('admin.expense-categories.*') || route().current('admin.investments.*') || route().current('admin.advances.*') || route().current('admin.accounts.*') || route().current('admin.transactions.*') || route().current('invoice-payments.*') || route().current('admin.client-dues') || route().current('admin.vendor-dues'),
    ...
    return (
        <div className="flex min-h-screen bg-[#f6f6f7] text-[#202223] antialiased font-sans">
            ...
            <nav className={`w-[260px] bg-[#010e22] text-[#e3e4e5] min-h-screen fixed z-50 transition-transform duration-300 ease-in-out flex flex-col ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
                ...
                <div className="p-[20px_24px] bg-[#010e22] text-[18px] font-semibold tracking-[0.5px] border-b border-[#2f3133] flex justify-between items-center shrink-0 h-[65px]">
                    <span className="flex items-center">
                        <i className="fa-brands fa-shopify text-[#008060] text-2xl mr-3"></i> 
                        Office Admin
                    </span>
                    <button onClick={() => setIsSidebarOpen(false)} className="md:hidden text-gray-400 hover:text-white p-1 rounded-md">
                ...
                <div className="flex-1 overflow-y-auto py-4 custom-scrollbar">
                    <ul className="list-none p-0 m-0 space-y-1">
                        ...
                        <li className="mx-3">
                            <Link href={route('dashboard')} className={`flex items-center px-4 py-2.5 text-[14px] rounded-md font-medium transition-colors ${route().current('dashboard') ? 'bg-[#008060] text-white' : 'text-[#b5b9bc] hover:text-white hover:bg-white/5'}`}>
                                <i className="fa-solid fa-chart-bar w-6 text-left opacity-90"></i> Dashboard
                            </Link>
                        </li>
                        ...
                        <li className="mx-3 mt-1">
                            ...
                            {openMenus.crm && (
                                <ul className="list-none p-0 mt-1 mb-2 bg-[#021528] rounded-md py-2 space-y-1">
                                    <li>
                                        <Link href={route('admin.clients.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.clients.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                                            <i className="fa-solid fa-users-line mr-2 text-[10px]"></i> Clients
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href={route('admin.projects.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.projects.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                                            <i className="fa-solid fa-layer-group mr-2 text-[10px]"></i> Projects
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href={route('admin.tasks.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.tasks.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                        ...
                        <li className="mx-3 mt-1">
                            <button
                                onClick={() => toggleMenu('projectExpense')}
                                className={`w-full flex items-center px-4 py-2.5 text-[14px] rounded-md font-medium transition-colors ${
                                    openMenus.projectExpense
                                        ? 'text-white'
                                        : 'text-[#b5b9bc] hover:text-white hover:bg-white/5'
                                }`}
                            >
                                <i className="fa-solid fa-wallet w-6 text-left opacity-80"></i>
                                Project Expense
                                <i
                                    className={`fa-solid fa-chevron-right ml-auto text-[11px] transition-transform duration-200 ${
                                        openMenus.projectExpense ? 'rotate-90' : ''
                                    }`}
                                ></i>
                            </button>
                            ...
                            {openMenus.projectExpense && (
                                <ul className="list-none p-0 mt-1 mb-2 bg-[#021528] rounded-md py-2 space-y-1">
                                    <li>
                                        <Link
                                            href={route('admin.project-expenses.index')}
                                            className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${
                                                route().current('admin.project-expenses.*')
                                                    ? 'text-white font-bold'
                                                    : 'text-[#a1a5a8] hover:text-white'
                                            }`}
                                        >
                                            <i className="fa-solid fa-money-check-dollar mr-2 text-[10px]"></i>
                                            Project Expenses
                                        </Link>
                                    </li>
                                </ul>
                        ...
                        <li className="mx-3 mt-1">
                            ...
                            {openMenus.finance && (
                                <ul className="list-none p-0 mt-1 mb-2 bg-[#021528] rounded-md py-2 space-y-1">
                                    ...
                                    <li>
                                        <Link href={route('admin.expenses.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.expenses.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                                            <i className="fa-solid fa-receipt mr-2 text-[10px]"></i> Expenses
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href={route('admin.expense-categories.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.expense-categories.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                                    ...
                                    <li>
                                        <Link href={route('invoice-payments.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('invoice-payments.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                                            <i className="fa-solid fa-money-bill-wave mr-2 text-[10px]"></i> Receive Payments
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href={route('admin.client-dues')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.client-dues') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                                            <i className="fa-solid fa-file-invoice-dollar mr-2 text-[10px]"></i> Client Dues Report
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href={route('admin.vendor-dues')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.vendor-dues') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                        ...
                        <li className="mx-3 mt-1">
                            ...
                            {openMenus.hr && (
                                <ul className="list-none p-0 mt-1 mb-2 bg-[#021528] rounded-md py-2 space-y-1">
                                    <li>
                                        <Link href={route('admin.employees.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.employees.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                                            <i className="fa-solid fa-id-card mr-2 text-[10px]"></i> Employees
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href={route('admin.attendances.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.attendances.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                                            <i className="fa-solid fa-clock-rotate-left mr-2 text-[10px]"></i> Attendance
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href={route('admin.salaries.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.salaries.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                                            <i className="fa-solid fa-money-check-dollar mr-2 text-[10px]"></i> Payroll / Salary
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href={route('admin.leaves.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.leaves.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                                            <i className="fa-solid fa-calendar-minus mr-2 text-[10px]"></i> Leave Applications
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href={route('admin.departments.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.departments.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                                            <i className="fa-solid fa-building-user mr-2 text-[10px]"></i> Departments
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href={route('admin.designations.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.designations.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                        ...
                        <li className="mx-3 mt-1">
                            ...
                            {openMenus.office && (
                                <ul className="list-none p-0 mt-1 mb-2 bg-[#021528] rounded-md py-2 space-y-1">
                                    <li>
                                        <Link href={route('admin.assets.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.assets.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                                            <i className="fa-solid fa-boxes-stacked mr-2 text-[10px]"></i> Assets
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href={route('admin.requisitions.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.requisitions.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                                            <i className="fa-solid fa-clipboard-list mr-2 text-[10px]"></i> Requisitions
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href={route('admin.notices.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.notices.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                        ...
                        <li className="mx-3">
                            ...
                            {openMenus.access && (
                                <ul className="list-none p-0 mt-1 mb-2 bg-[#021528] rounded-md py-2 space-y-1">
                                    <li>
                                        <Link href={route('admin.users.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.users.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                                            <i className="fa-solid fa-users mr-2 text-[10px]"></i> Users
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href={route('admin.roles.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.roles.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
                                            <i className="fa-solid fa-user-tag mr-2 text-[10px]"></i> Roles
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href={route('admin.permissions.index')} className={`flex items-center pl-10 py-2 text-[13px] transition-colors ${route().current('admin.permissions.*') ? 'text-white font-bold' : 'text-[#a1a5a8] hover:text-white'}`}>
